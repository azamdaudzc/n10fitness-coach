<div class="card-body">
    ...
    <div class="d-flex flex-center flex-column py-5">
        ...
        <!--begin::Name-->
        <a href="#"
            class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $library->first_name }}
            {{ $library->last_name }}</a>
        <!--end::Name-->
        <!--begin::Position-->
        <div class="mb-9">
    ...
    <div id="kt_user_view_details" class="collapse show">
        <div class="pb-5 fs-6">
            ...
            <div class="text-gray-600">
                <a href="#" class="text-gray-600 text-hover-primary">{{ $library->email }}</a>
            </div>
            <!--begin::Details item-->
            <!--begin::Details item-->
            <div class="fw-bold mt-5">Phone</div>
            <div class="text-gray-600">{{ $library->phone }}</div>
            <!--begin::Details item-->
