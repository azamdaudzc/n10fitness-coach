<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-body p-9">
        ...
        <div class="d-flex flex-column">
            <h2 class="mb-1">program Videos</h2>
            @foreach ($videos as $lm)
            <div class="text-muted fw-bold">

                <a href="{{ $lm->video_url }}" target="_blank">
                    <div class="programvideo-container">
                        <div class="programvideo-top"></div>
                        <img src="{{  $lm->thumbnail }}" class=" mt-3  w-100 h-80 programvideo-image" />
                        <div class="programvideo-middle">
                            <img src="{{asset('assets/media/sample/video-play-icon.png')}}" class="programvideo-text" alt="">
                        </div>
                    </div>
                </a>
            </div>
