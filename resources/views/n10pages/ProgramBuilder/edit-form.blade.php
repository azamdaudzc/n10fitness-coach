                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="kt_accordion_group_{{ $i }}_header_1">
                                <button
                                    ...
                                    data-bs-target="#kt_accordion_group_{{ $i }}_body_1" aria-expanded="true"
                                    aria-controls="kt_accordion_group_{{ $i }}_body_1">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <input type="number" name="group-{{ $i }}-proteins"
                                                        ...
                                                        class="form-control"
                                                        value="{{ $per_group_data[$i]->assigned_proteins }}">
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <input type="number" name="group-{{ $i }}-calories"
                                                        ...
                                                        class="form-control"
                                                        value="{{ $per_group_data[$i]->assigned_calories }}">
                                                </div>
