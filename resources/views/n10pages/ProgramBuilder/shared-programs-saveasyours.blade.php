    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form action="{{ route('program.builder.store') }}" method="post">
                ...
                <input type="hidden" name="group_counter" id="group-counter" value="{{ $week_group_count+1 }}">
                <input type="hidden" id="program-weeks" name="no_of_weeks" class="form-control" value="{{ $program->weeks }}">
                <input type="hidden" id="program-days" name="no_of_days" class="form-control" placeholder="Days" value="{{ $program->days }}">
